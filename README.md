...
降为 1900/1500，超长正文继续按句子边界拆分，作者、单位、邮箱、宏定义和纯环境配置不送模型。当前 **chunk v55-config-command-boundary** 还会剥离
...
全文翻译当前使用 chunk v55-config-command-boundary。正文按数学邻接、章节结构和自然句边界
